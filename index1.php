<?php
	...
	if (isset($_POST['agregar_usuario']) && isset($_POST['correo_usuario']) && isset($_POST['contrasena_nueva']) ) {
		...
		if ($rol) {
			...
			switch ($rol[0][0]) {
				case 1:
					header("Location: ".$URL_CONST."proyecto-web/administrador.html");
					break;

				case 2:
					header("Location: ".$URL_CONST."proyecto-web/profesor.html");
					break;
				case 3:
					header("Location: ".$URL_CONST."proyecto-web/alumno.html");
					break;
			}
